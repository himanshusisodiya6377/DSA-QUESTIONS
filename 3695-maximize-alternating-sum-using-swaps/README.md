<h2><a href="https://leetcode.com/problems/maximize-alternating-sum-using-swaps">3695. Maximize Alternating Sum Using Swaps</a></h2><h3>Hard</h3><hr><p>You are given an integer array <code>nums</code>.</p>
