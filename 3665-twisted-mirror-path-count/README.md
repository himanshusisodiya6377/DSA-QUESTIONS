<h2><a href="https://leetcode.com/problems/twisted-mirror-path-count">3665. Twisted Mirror Path Count</a></h2><h3>Medium</h3><hr><p>Given an <code>m x n</code> binary grid <code>grid</code> where:</p>
