<h2><a href="https://leetcode.com/problems/remove-nodes-from-linked-list/description/">2487. Remove Nodes From Linked List</a></h2><h3>Medium</h3><hr><p>You are given the <code>head</code> of a linked list.</p>
